...
const uint32_t const_1 = 10;
const uint32_t const_2 = 10;
const uint8_t uint8_const = 10;
...
int main(void)
{
	...
	// initialise_monitor_handles(); // debug using semi hosting
...
void HardFault_Handler_c(uint32_t *pBaseStackFrame)
{
	...
	pMSP = pBaseStackFrame;
	MSP_val = (*pHFSR) & 0xFFFFFFFF;
	printf("UFSR = %lx\n",(*pHFSR) & 0xFFFFFFFF);
